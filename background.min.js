...
(function () {
  var e = "\" ' ( ) , - . / 0 1 2 : ? a about and are as be but com for from have i in is it like may more my next not of on search that the this to was when with you your".split(" ")
    , m = !1
    , p = {}
    , q = {}
    , r = 0
    ...
    , G = function (a, b, c) {
      ...
      _gaq && _gaq.push(["_trackEvent", "lookup", a.type]); - 1 !== t && w !== a.instanceId && chrome.tabs.sendMessage(t, {
        type: "hide"
        , instanceId: w
      });
      "fetch_raw" === a.type ? (t = b.tab.id, w = a.instanceId) : w = t = -1;
      var d = y(a.query)
        , f = function () {
          var b = {
            request: a
          ...
          D(d, p.language, function (a) {
            b.dictRes = a;
            E(b)
          });
          "en" !== p.language ? D(d, "en", function (a) {
            b.enDictRes = a;
            E(b)
          }) : E(b);
          F(d, "auto", function (a) {
          ...
          chrome.tabs.getSelected(null, function (a) {
            ...
            chrome.tabs.detectLanguage(a.id, function (a) {
              b.tabLangTranReqTimedOut || (window.clearTimeout(c)
                , "und" !== a ? (b.tabLang = "he" === a ? "iw" : a, F(d, b.tabLang, function (a) {
                  b.tabLangTranRes = a;
                  E(b)
                })) : E(b))
            })
    ...
    , D = function (a, b, c) {
      ...
      gapi.client.request(a)
        .execute(function (a) {
          a = H(a, "dictionaryData[0]");
          if (!a) return c(null);
          var b = function (a) {
              if (!a.senseFamilies) return 0;
              a = a.senseFamilies;
              for (var b = a.length, c = 0; c < a.length; c++) a[c].senses && (b += .1 * a[c].senses.length);
              return b
            }
            , k = function (a, c) {
              return b(c) - b(a)
    ...
    , E = function (a) {
      ...
      if (4 === a.numResponses) {
        ...
        var d = J(a.tranRes, !0)
          ...
          , n = null
          , l = null;
        f && a.tabLang !== k ? (g = !0, n = a.tabLangTranRes, l = f) : !b && d && (g = !0, n = a.tranRes, l = d);
        g && c && c.audio && "en" === l.srcLang.toLowerCase() && (l.audio = c.audio);
        c = g ? "translation" : "definition";
        b || l || (c = "none");
        _gaq && _gaq.push(["_trackEvent", "lookup", "type_" + c]);
        f = encodeURIComponent(a.sanitizedQuery);
        c =
          "";
        g && (c = "https://translate.google.com/translate_t?source=dict-chrome-ex&sl=" + l.srcLang + "&tl=" + p.language + "&q=" + f);
        d = "https://www.google.com/search?source=dict-chrome-ex&defl=" + p.language + "&hl=" + p.language + "&q=" + f + "&tbo=1&tbs=dfn:1";
        "en" === p.language && (d = "https://www.google.com/search?q=define+" + f);
        if ("fetch_html" === a.request.type) b = "", b = g ? K(n, l.audio, c) : L(a.dictRes, d), g = {
          ...
          h && "true" === p.storeHistory && !a.incognito && chrome.storage.local.get("word-history", function (b) {
            u = h.srcLang + "<" + p.language + "<" + a.sanitizedQuery;
            b["word-history"][u] = h.meaningText;
            chrome.storage.local.set(b)
          });
          h && !h.prettyQuery && (h.prettyQuery = a.sanitizedQuery);
          g = !1;
          ("true" === p.popupDblclick && "none" === p.popupDblclickKey || "true" === p.popupSelect && "none" === p.popupSelectKey) && z(a.sanitizedQuery) && (g = !0);
          g = {
            eventKey: a.request.eventKey
            , sanitizedQuery: a.sanitizedQuery
            , meaningObj: h
    ...
    , J = function (a, b) {
      ...
      if (b && a.dict && 0 < a.dict.length)
        for (var k = 0, g = a.dict.length; k < g; k++)
          for (var n = a.dict[k], l = 0, h = 0, u = n.terms.length; h < u && 2 > l; h++) {
            var v = n.terms[h].toLowerCase();
            0 < v.length && v !== c && v !== d && (f += ", " + v, l++)
          }
      c = x(f);
    ...
    , H = function (a, b) {
      for (var c = b.split("."), d = 0; d < c.length; d++) {
        ...
        if ("]" === f.charAt(f.length - 1)) {
          f = f.split("[");
          console.assert(2 === f.length);
          var k = parseInt(f[1].slice(0, -1), 10);
          a = a[f[0]];
          if (!a) return null;
          a = a[k]
        } else a = a[f];
    ...
    , I = function (a) {
      ...
      var b = null
        , c = null;
      if (b = H(a, "entries[0]")) c = {
        prettyQuery: b.syllabifiedHeadword || b.headword
        , meaningText: H(b, "senseFamilies[0].senses[0].definition.text")
        , attribution: ""
        , audio: H(b, "phonetics[0].drEyeAudio")
        , type: "licensedDef"
      }, c.meaningText ? c.audio && (c.audio = M(c.audio)) : c = null;
      !c && (b = H(a, "webDefinitions[0]")) && (c = b.sourceUrl, c = {
  ...
  window.initBackgroundPageAsync = function (a) {
    ...
    P("templates/browser_action_dict.html", function (a) {
      q.browser_action_dict = Mustache.compile(a);
      b()
    });
    P("templates/browser_action_tran.html", function (a) {
      q.browser_action_tran = Mustache.compile(a);
      b()
    })
  };
  window.initBackgroundPage = Q;
  var R = R || !1;
  R || Q();
})();
